<!-- default badges list -->
![](https://img.shields.io/endpoint?url=https://codecentral.devexpress.com/api/v1/VersionRange/1142556531/25.2.5%2B)
...
-   [ConsoleDashboards.dpr] generates a dashboard in non-interactive (headless) mode.
-   [CountrySalesDashboard.xml] contains a dashboard layout designed to generate a country sales dashboard.
    You can open the same dashboard in the Dashboard Designer and Viewer using the [dashboard with a hidden parameter example application][hidden-parameter-example].
